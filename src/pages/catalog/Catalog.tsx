        ...
        <section className="bg-primary py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-white/90 text-center max-w-2xl mx-auto">
              Широкий ассортимент климатического оборудования от ведущих
              производителей
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="bg-white dark:bg-gray-900 rounded-lg p-6 text-center shadow-card hover:shadow-card-hover transition-shadow"
                >
                  <div className="h-12 flex items-center justify-center mb-2">
                    <span className="font-heading font-bold text-primary dark:text-white">
                      {brand}
                    </span>
                  </div>
                </div>
