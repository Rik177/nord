...
const categories: Category[] = [
  {
    ...
    image: "https://images.pexels.com/photos/4270511/pexels-photo-4270511.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&dpr=1",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/8486972/pexels-photo-8486972.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&dpr=1",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/7109803/pexels-photo-7109803.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&dpr=1",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/7191981/pexels-photo-7191981.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&dpr=1",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/6646917/pexels-photo-6646917.jpeg?auto=compress&cs=tinysrgb&w=1200&h=800&dpr=1",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/6444/pencil-typography-black-design.jpg?auto=compress&cs=tinysrgb&w=1200&h=800&dpr=1",
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        {/* Categories Grid - полностью переработанная версия */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {categories.map((category, index) => (
            <a
              key={category.id}
              href={category.link}
              className="category-card group relative rounded-2xl overflow-hidden shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-2 bg-white dark:bg-gray-800"
            >
              {/* Большое изображение на всю карточку */}
              <div className="relative h-80 sm:h-96 overflow-hidden">
                ...
                {/* Градиентный оверлей */}
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/20 opacity-80 group-hover:opacity-90 transition-opacity duration-300"></div>
                
                {/* Контент поверх изображения */}
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <div className="text-white">
                    <h3 className="font-heading font-bold text-2xl lg:text-3xl mb-3 group-hover:text-accent transition-colors duration-300">
                      {category.title}
                    </h3>
                    
                    {category.description && (
                      <p className="text-white/90 text-base mb-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-100">
                        {category.description}
                      </p>
                    )}
                    
                    {/* CTA Button */}
                    <div className="flex items-center text-accent font-semibold text-lg opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-200">
                ...
                {/* Рамка при ховере */}
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-accent/60 rounded-2xl transition-colors duration-300"></div>
              </div>
            </a>
          ))}
        </div>
